...
public class BookDA {
	...
	public static int addBookToDA(int isbn, String category, String author, String title, int edition, String publisher,
		...
		if (checkIsbn == false)
		{
			//if isbn doesnt exist, add the book to the database
	...
	//returns a SQL set containing all currently active books
	...
	//returns a SQL set containing the details of a certain book
	...
	//edit a certain book in the database
	...
	//get sales reports on certain books (used by the manager)
	public static SimpleHash getBookReport() {
		...
		//update how many books are in stock
